...
As an example, we will use the `greekLetter`^[`install.packages(greekLetters)`] package and use the `print_greeks()` function to obtain greek letters in R. Lastly, create a vector called `greek_10`.
